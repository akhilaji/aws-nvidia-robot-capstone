...
// Draw Detection
void draw_detections_cv_v3(int global_frame_counter, FILE *results_output, mat_cv* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output);
