    ...
    int benchmark, int benchmark_layers)
{
    ...
    while(1){
        ++count;
        {
            ...
            if (!benchmark && !dontdraw_bbox) draw_detections_cv_v3(global_frame_counter, results_output, show_img, local_dets, local_nboxes, demo_thresh, demo_names, demo_alphabet, demo_classes, demo_ext_output);
